...
from PushbuttonsStyles import stylesheetclass
...
"padding-bottom:7px;")
        ...
        self.pushButton.clicked.connect(lambda:self.Downloader())
    ...
    def Downloader(self):
              if self.lineEdit.text()=="":
                    self.lineEdit.setPlaceholderText("Paste link to movie")
              else:
